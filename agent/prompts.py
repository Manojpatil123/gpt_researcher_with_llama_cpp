...
def generate_report_prompt(question, research_summary):
    ...
    return f'"""{research_summary}""" Using the above information, answer the following'\
           ...
           " The report should focus on the answer to the question, should be well structured, informative,Please ensure that headings are  bold, and  titles are provided for each paragraph with bold , and keywords are included. Additionally, remember to conclude the content with a well-structured final statement." \
...
def generate_search_queries_prompt(question):
    ...
    return f'Write 2 google search queries to search online that form an objective opinion from the following: "{question}"'\
           f'You must respond with a list of strings in the following format just give 2 query dont explain them : "query 1" : , "query 2":'
...
def generate_outline_report_prompt(question, research_summary):
    ...
    return f'"""{research_summary}""" Using the above information, generate an outline for a research report in Markdown syntax'\
           ...
           "Please ensure that headings are  bold, and  titles are provided for each paragraph with bold , and keywords are included. Additionally, remember to conclude the content with a well-structured final statement.."
...
def generate_concepts_prompt(question, research_summary):
    ...
    return f'"""{research_summary}""" Using the above information, generate a list of 5 main concepts to learn for a research report'\
           ...
           'You must respond with a list of strings in the following format: ["concepts 1", "concepts 2", "concepts 3", "concepts 4, concepts 5"].Please ensure that headings are  bold, and  titles are provided for each paragraph with bold , and keywords are included. Additionally, remember to conclude the content with a well-structured final statement.'
...
def generate_lesson_prompt(concept):
    ...
    f'fields, and notable events or facts related to {concept}.Properly bold headings , title for each pragraph and  keywords.  and conlcude with proper conclusion'
...
def auto_agent_instructions():
    return """
        ...
        give ouput in this format for the user input , take refrence of example
        {
            "agent:  "agent namet",
            "agent_role_prompt": "prompt"
        }
    """
